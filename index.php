...
<html>
    <head>
		...
		<meta name="description" content="Pagina di cheter01 di prova per esperimenti sull'html">
		<meta name="”keywords”" content="cheter01 https://cheter01.github.io/cheter01/ pagina web Cheter01">
		<meta name="author" content="cheter01">
		<meta name="copyright" content="cheter01">
    ...
    <meta name="theme-color" content="#B5E853">
		...
		<link rel="shorcut icon" type="image/x-icon" href="images/Cheter01.ico" media="all">
    ...
    <body class='background'>
        ...
        <!-- <div id="id01" class="modal">
          ...
          <form class="modal-content animate" >
            ...
            <div class="login">
              ...
              <button align="center" id="login" type="button" onclick="log()">Login</button>
            </div>
          </form>
        </div> -->
      ...
      <div class="page_box">
              ...
              <div class='container-ex'>
                  ...
                  <img id='img-avatar' src='images/Cheter01.gif'>
    		        	<h1>Cheter01</h1>
    		        	<h2>Main Page</h2>
			            <section id="buttons">
    		            <a href="./compleanni/index.html" class="btn btn-cheter01"><span class="icon"></span>Compleanni</a>
    		            </section>
    		        </div>
                <div class='container-ex'>
                </div>
	    		    ...
	    		    <div class="container">
                <img id="img-head" src='images/Welcome.gif'>
        		    <section id="main_content">
    	    	     <h3>
    	    	      <a id="benvenuti-nella-pagina-di-cheter01" class="anchor" href="#benvenuti-nella-pagina-di-cheter01" aria-hidden="true">
    	    	     		<span aria-hidden="true" class="octicon octicon-link">
    	    	      	</span>
    	    	      </a>Benvenuti nella pagina di Cheter01.
    	        	 </h3>

    	        	 <p>Benvenuti in questa nuova pagina web creata da me, Cheter01; spero vi divertiate a non fare nulla.</p>
                ...
                <p>
                  ...
                  un giorno però accadde che la piccola riga di un testo casuale, di nome lorem ipsum, decise di andare a esplorare la vasta graMmatica.
                  il grande Oximox tentò di dissuadeRla, poIché quel luogo pullulava di viRgole spiEtate, punti interrogativi selvaggi e subdoli punti e virgola, ma il piccolo testo casuale non si fece certo fuorviare.
                ...
                <hr>
 			    	    ...
 			    	    <h3>
 			    	     <a id="Cheter01" class="anchor" href="#authors-and-contributors" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cheter01
 			    	    </h3>

 			   	      <ul>
 			   	       <li>
 			  	        Drive: <a href="https://drive.google.com/drive/folders/0B37wmZ0KBkaRc0RpeTE5RVRHbDg?usp=sharing">Programmi</a>
 			  	       </li>
					       <li>
						      Informatica: <a href="./progetti_informatica/index.html">Progetti</a>
						      </li>
 			    	    </ul>

               <hr>
               <!-- ingranaggi filali -->
    		       <div class='gear' align="center">
                <svg class="u-hidden">
                  <symbol id="wheel" viewBox="0 0 612 612">
                ...
                <div class="hole">
                  ...
                  <!-- ruota segreta per il link -->
                  <svg class="wheel" onclick="window.open('./tic-tac-toe/index.html','mywindow');" style="cursor: pointer;">
                    <use xlink:href="#wheel"></use>
                  </svg>
        ...
        <script type="text/javascript" src="javascripts/ip.js"></script>
    </body>
</html>
