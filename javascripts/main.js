/* get-distance.js */
			...
			class NodeGarden {
			  ...
			  init() {
			    const body  = document.querySelector(this.element);
			    this.context = body.getContext('2d');

			    const width  = body.width  = this.width;
			    const height = body.height = this.height;
			...
			const nodeGarden = new NodeGarden('.js-body');
